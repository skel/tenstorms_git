    ...
    public:
        ...
        class spell_putricide_mutation_init_AuraScript : public AuraScript
        {
            ...
            void OnRemove(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
            {
                ...
                if (GetTargetApplication()->GetTarget()->GetMap()->GetSpawnMode() & 1)
                    spellId = 71503;

                GetTargetApplication()->GetTarget()->CastSpell(GetTargetApplication()->GetTarget(), spellId, true);
            }
...
class spell_putricide_mutated_transformation_dismiss : public SpellScriptLoader
{
    public:
        ...
        class spell_putricide_mutated_transformation_dismiss_AuraScript : public AuraScript
        {
            ...
            void OnRemove(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
            {
                if (Vehicle* veh = GetTargetApplication()->GetTarget()->GetVehicleKit())
